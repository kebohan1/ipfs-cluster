...
type IPFSConnector interface {
	...
	LsCid(ctx context.Context, pin *api.Pin) (api.IPFSPinStatus, error)
...
type PinTracker interface {
	...
	// SyncAll Added by KBH 2020/09/21
	SyncAll(ctx context.Context) ([]*api.PinInfo, error)
	// Sync added by KBH 2020/9/21
	Sync(ctx context.Context, c cid.Cid) (*api.PinInfo, error)
}
